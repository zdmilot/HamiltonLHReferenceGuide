...
This function is used to disable the temperature events that are traced in the logfile during method runtime.

### Syntax

```
DisableTemperatureEvent (variable i_intDeviceID, 
