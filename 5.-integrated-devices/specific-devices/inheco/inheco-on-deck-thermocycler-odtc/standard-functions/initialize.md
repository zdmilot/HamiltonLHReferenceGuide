...
This function is used to initialize the Inheco ODTC device.

This function has to be excuted before any methods can be executed.

### Syntax

```
Initialize (variable i_intDeviceID, 
