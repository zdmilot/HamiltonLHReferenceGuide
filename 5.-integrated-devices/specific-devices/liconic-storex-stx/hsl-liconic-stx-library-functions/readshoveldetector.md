...
| ReadShovelDetector ( | variable iUnitID,       |   |
| -------------------- | ----------------------- | - |
|                      | variable& oShovelStatus | ) |
...
This function returns the shovel status of the Liconix STX device identified by _iUnitID_.
...
| oShovelStatus \[out] | integer \[0..1] | <p>0: no plate present on shovel</p><p>1: plate present on shovel</p>                                                                                                                                                                                                                                                                                                                                                                        |
