...
This function is used to stop a running method on the device.

To start a method, use either function ExecuteMethod or StartExecuteProtocol.

### Syntax

```
StopMethod (variable i_intDeviceID, 
