...
2.  Go through the Remove SQL Server wizard to remove the HAMILTON SQL server instance as well as all components and features. When prompted for which features to remove, click Select All.
    ...
    <figure><img src="../../.gitbook/assets/image (67).png" alt="" width="525"><figcaption></figcaption></figure>
...
6. Delete these registry entries (if remaining) from the Windows Registry:
   ...
   *   Computer\HKEY\_CURRENT\_USER\SOFTWARE\Hamilton Company\
       ...
       <figure><img src="../../.gitbook/assets/image (72).png" alt="" width="212"><figcaption></figcaption></figure>

        

       <figure><img src="../../.gitbook/assets/image (70).png" alt="" width="275"><figcaption></figcaption></figure>

        

       <figure><img src="../../.gitbook/assets/image (71).png" alt="" width="335"><figcaption></figcaption></figure>
