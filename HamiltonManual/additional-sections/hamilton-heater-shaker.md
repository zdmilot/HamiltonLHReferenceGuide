...
1.  #### _‌Programming the Hamilton Heater Shaker‌_
    ...
    | 1 – 2            | <p><br></p><p><img src="../.gitbook/manual-images/assets/Image_1595.jpg" alt="image" data-size="original"></p> | <p>Create Star Device</p><p>(Establish a connection to 1 or 2 shakers connected via TCC)</p>                  |
    | 1 – 8            | <p><br></p><p><img src="../.gitbook/manual-images/assets/Image_1596.jpg" alt="image" data-size="original"></p> | <p>Create USB Device</p><p>(Establish a connection to up to 8 heater shakers using the heater shaker box)</p> |
