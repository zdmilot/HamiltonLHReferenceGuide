...
6. If the \[Play] Button is clicked![](<../.gitbook/assets/image (37) (1).png>), observe that one column of dots at a time changes its color for a short time, beginning at the left column, running from left to right. Simply click the \[Stop] Button in the toolbar to stop the play.
