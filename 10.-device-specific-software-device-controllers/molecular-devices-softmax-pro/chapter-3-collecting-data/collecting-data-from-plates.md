...
1. To open the plate drawer of the instrument, select the **Home** tab and click ![](<../../../.gitbook/assets/5 (6).png>)
...
2. Click ![](<../../../.gitbook/assets/6 (6).png>) **Open/Close** to close the plate drawer.
...
5. Click ![](<../../../.gitbook/assets/7 (4).jpeg>) **Read** below the Settings Information area or on the Home tab. The Read button changes to ![](<../../../.gitbook/assets/8 (1).jpeg>) **Stop** so you can terminate a read.
6. The instrument reads the Plate section you select.

![](<../../../.gitbook/assets/9 (3).png>) For the SpectraMax i3x, SpectraMax Paradigm, SpectraMax iD3, SpectraMax iD5, FilterMax F3, and FilterMax F5 and you select to do pre-read optimizations, the Pre- Read Optimization Options dialog displays. See Pre-Read Optimization Options on page 184.

![](<../../../.gitbook/assets/10 (1).png>) For the SpectraMax i3x and SpectraMax Paradigm with a Tunable Wavelength (TUNE) Detection Cartridge and select to run spectral optimization, the Spectral Optimization Wizard runs before the plate is read. See Spectral Optimization on page 182.
...
*
  ...
  2. Click ![](<../../../.gitbook/assets/14 (1).jpeg>) in the section toolbar, in the Settings Information area, or on the Home tab to display the Settings dialog.
...
1. To change the wavelengths for the read, either: ![](<../../../.gitbook/assets/17 (3).png>) Drag the cross hair to a new location
...
![](<../../../.gitbook/assets/19 (1).png>) Select **Copy Raw Data** to copy the data in a tab-delimited format that you can paste into a spreadsheet or text editor (SpectraMax i3x only).

![](<../../../.gitbook/assets/20 (2).png>) Select **Copy Image** to copy the image into a bitmap file that you can paste into an image editing program.
