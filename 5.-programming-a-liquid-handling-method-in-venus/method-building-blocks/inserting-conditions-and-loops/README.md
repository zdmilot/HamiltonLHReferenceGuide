...
![](../../../.gitbook/assets/3.png)Add the General Step **Loop** to your Method and the **Loop** dialogue window appears

![](../../../.gitbook/assets/4.png)Select the way to Loop, provide any info needed, and click **OK**

![](../../../.gitbook/assets/5.png)An empty **Loop**-**End Loop** step combo is added to the Method
...
1. ![](../../../.gitbook/assets/6.png)Repeat the step 12 times
...
![](../../../.gitbook/assets/8.png)TargetPlatesX4 are processed

1. ![](../../../.gitbook/assets/9.png)Read each record from the work list until the end-of-file is reached
