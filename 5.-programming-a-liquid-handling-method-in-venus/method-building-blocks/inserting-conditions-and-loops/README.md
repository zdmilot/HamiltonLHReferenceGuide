...
### ![](../../../.gitbook/assets/1.jpeg)Loops <a href="#slide-number-2" id="slide-number-2"></a>
...
### ![](../../../.gitbook/assets/2.jpeg)Using Loops <a href="#slide-number-3" id="slide-number-3"></a>

![](<../../../.gitbook/assets/3 (1).png>)Add the General Step **Loop** to your Method and the **Loop** dialogue window appears

![](<../../../.gitbook/assets/4 (1).png>)Select the way to Loop, provide any info needed, and click **OK**

![](<../../../.gitbook/assets/5 (1).png>)An empty **Loop**-**End Loop** step combo is added to the Method
...
1. ![](<../../../.gitbook/assets/6 (1).png>)Repeat the step 12 times
...
![](<../../../.gitbook/assets/8 (1).png>)TargetPlatesX4 are processed

1. ![](<../../../.gitbook/assets/9 (1).png>)Read each record from the work list until the end-of-file is reached
...
![](../../../.gitbook/assets/13.png)**before & after loop** = **current position** set to 1 _before & after_ Loop step
...
![](../../../.gitbook/assets/14.jpeg)To force a **Loop** to end prematurely, use the **Loop Break** step. Processing continues with the next step after the **End Loop.**

![](../../../.gitbook/assets/15.jpeg)**Loop counter variable** created by the **Loop** step automatically keeps count of the number of iterations. **Loop counter variable** = **0** before **Loop** execution starts, and is incremented by **1** every time the **Loop** body is entered

![](../../../.gitbook/assets/16.png)**Loops** can contain other **Loops**
...
![](../../../.gitbook/assets/19.jpeg)Challenge 6:
