...
| <img src="../../../.gitbook/assets/image (69) (1) (1) (1) (1) (1) (1).png" alt="" data-size="original"> | <p></p><p><strong>Liquid following during aspirate and mix:</strong> Tips fall and rise with the liquid level<br><br>Pre-rinsing/Mix settings:</p><ul><li><strong>Cycles:</strong> Number of mixing cycles</li><li><strong>Mix position [mm]:</strong> Immersion depth from the set aspirate/dispense depth.</li><li><strong>Volume [µl]:</strong> Mixing volume (generally half of the volume in the container)</li></ul> |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
{% endtab %}
{% endtabs %}
