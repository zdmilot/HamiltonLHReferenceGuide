...
1. ![](<../../../.gitbook/assets/6 (1) (1).png>)Repeat the step 12 times
...
![](<../../../.gitbook/assets/15 (1).jpeg>)**Loop counter variable** created by the **Loop** step automatically keeps count of the number of iterations. **Loop counter variable** = **0** before **Loop** execution starts, and is incremented by **1** every time the **Loop** body is entered

![](<../../../.gitbook/assets/16 (1).png>)**Loops** can contain other **Loops**
